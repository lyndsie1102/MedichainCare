...
class BootstrappingGrammarTests(TestCase):
    ...
    def test_spaceless_literal(self):
        ...
        self.assertEqual(
            spaceless_literal.parse(text),
            Node(
                spaceless_literal,
                text,
                0,
                len(text),
                children=[Node(spaceless_literal.members[0], text, 0, len(text))],
            ),
        )
        text = r'''r"\""'''
        self.assertEqual(
            ...
            Node(
                ...
                0,
                5,
                children=[Node(spaceless_literal.members[0], text, 0, 5)],
            ),
        )
    ...
    def test_optional(self):
        ...
        self.assertEqual(
            ...
            Node(
                ...
                0,
                5,
                children=[Node(Literal("howdy"), howdy, 0, 5)],
            ),
        )
...
class GrammarTests(TestCase):
    ...
    def test_expressions_from_rules(self):
        ...
        self.assertEqual(
            tree,
            Node(
                greeting_grammar["greeting"],
                "hi",
                0,
                2,
                children=[Node(Literal("hi"), "hi", 0, 2)],
            ),
        )
    ...
    def test_unicode(self):
        ...
        self.assertTrue(
            "text = ~'[A-Z 0-9]*'i%s" % ("u" if version_info >= (3,) else "") in lines
        )
    ...
    def test_comments(self):
        ...
        # \n or \r to end.
        self.assertEqual(
            list(sorted(str(grammar).splitlines())),
            [
                ...
                """stars = '**'""",
                """text = ~'[A-Z 0-9]*'i%s""" % ("u" if version_info >= (3,) else ""),
            ],
        )
    ...
    def test_simple_custom_rules(self):
        ...
        grammar = Grammar(
            ...
            digit=lambda text, pos: (pos + 1) if text[pos].isdigit() else None,
        )
        s = "[6]"
        self.assertEqual(
            grammar.parse(s),
            Node(
                grammar["bracketed_digit"],
                s,
                0,
                3,
                children=[
    ...
    def test_complex_custom_rules(self):
        ...
        grammar = Grammar(
            ...
            digit=lambda text, pos, cache, error, grammar: grammar[
                "real_digit"
            ].match_core(text, pos, cache, error),
        )
        s = "[6]"
        self.assertEqual(
            grammar.parse(s),
    ...
    def test_lazy_custom_rules(self):
        ...
        grammar = Grammar(
            ...
            five = '5'""",
            forty_five=Sequence(
                LazyReference("four"), LazyReference("five"), name="forty_five"
            ),
        ).default("forty_five")
        s = "45"
        self.assertEqual(
    ...
    def test_unconnected_custom_rules(self):
        ...
        s = "4"
        self.assertEqual(grammar.parse(s), Node(grammar["one_char"], s, 0, 1))
    ...
    def test_rule_ordering_is_preserved(self):
        ...
        self.assertEqual(list(grammar.keys()), ["r%s" % i for i in range(100)])
    ...
    def test_equal(self):
        ...
        self.assertNotEqual(
            Grammar('expr = ~"[a-z]{1,3}"'), Grammar('expr = ~"[a-z]{2,3}"')
        )
        self.assertNotEqual(
            Grammar('expr = ~"[a-z]{1,3}"'), Grammar('expr = ~"[a-z]{1,4}"')
        )
