...
# =============================================================================
_preamble = (
    "The CryptPolicy class has been deprecated as of "
...
class CryptPolicy(object):
    ...
    def from_path(cls, path, section="passlib", encoding="utf-8"):
        ...
        """
        warn(
            _preamble + "Instead of ``CryptPolicy.from_path(path)``, "
    ...
    def from_string(cls, source, section="passlib", encoding="utf-8"):
        ...
        """
        warn(
            _preamble + "Instead of ``CryptPolicy.from_string(source)``, "
        ...
        return cls(
            _internal_context=CryptContext.from_string(source, section, encoding)
        )
    ...
    def from_source(cls, source, _warn=True):
        ...
        if _warn:
            warn(
                _preamble + "Instead of ``CryptPolicy.from_source()``, "
        ...
        if isinstance(source, CryptPolicy):
            ...
            raise TypeError(
                "source must be CryptPolicy, dict, config string, "
    ...
    def from_sources(cls, sources, _warn=True):
        ...
        if _warn:
            warn(
                _preamble + "Instead of ``CryptPolicy.from_sources()``, "
        ...
        for source in sources:
            kwds.update(
                cls.from_source(source, _warn=False)._context.to_dict(resolve=True)
            )
    ...
    def replace(self, *args, **kwds):
        ...
        if self._stub_policy:
            warn(
                _preamble  # pragma: no cover -- deprecated & unused
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().replace()``, "
    ...
    def __init__(self, *args, **kwds):
        ...
        if context:
            ...
            if args:
                ...
                kwds = args[0]
            warn(
                _preamble + "Instead of constructing a CryptPolicy instance, "
    ...
    def has_schemes(self):
        ...
        if self._stub_policy:
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().has_schemes()``, "
                "create a CryptContext instance and "
                "use ``bool(context.schemes())``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def iter_handlers(self):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.iter_handlers()``, "
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().iter_handlers()``, "
                "create a CryptContext instance and "
                "use ``context.schemes(resolve=True)``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def schemes(self, resolve=False):
        ...
        if self._stub_policy:
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().schemes()``, "
                "create a CryptContext instance and "
                "use ``context.schemes()``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def get_handler(self, name=None, category=None, required=False):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.get_handler()``, "
                "use ``context.handler()``.",
                DeprecationWarning,
                stacklevel=2,
            )
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().get_handler()``, "
                "create a CryptContext instance and "
                "use ``context.handler()``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def get_min_verify_time(self, category=None):
        ...
        """
        warn(
            "get_min_verify_time() and min_verify_time option is deprecated and ignored, "
    ...
    def iter_config(self, ini=False, resolve=False):
        ...
        if self._stub_policy:
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().iter_config()``, "
                "create a CryptContext instance and "
                "use ``context.to_dict().items()``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def to_dict(self, resolve=False):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.to_dict()``, "
                "use ``context.to_dict()``.",
                DeprecationWarning,
                stacklevel=2,
            )
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().to_dict()``, "
                "create a CryptContext instance and "
                "use ``context.to_dict()``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def to_file(
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.to_file(stream)``, "
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().to_file(stream)``, "
                "create a CryptContext instance and "
                "use ``stream.write(context.to_string())``.",
                DeprecationWarning,
                stacklevel=2,
    ...
    def to_string(self, section="passlib", encoding=None):
        ...
        if self._stub_policy:
            ...
            warn(
                _preamble + "Instead of ``CryptPolicy().to_string()``, "
                "create a CryptContext instance and "
                "use ``context.to_string()``.",
                DeprecationWarning,
                stacklevel=2,
...
class _CryptConfig(object):
    ...
    def _norm_context_option(self, cat, key, value):
        ...
        if key == "default":
            ...
            warn(
                "'min_verify_time' was deprecated in Passlib 1.6, is "
                "ignored in 1.7, and will be removed in 1.8",
                DeprecationWarning,
            )
        elif key == "harden_verify":
            warn(
                "'harden_verify' is deprecated & ignored as of Passlib 1.7.1, "
...
class CryptContext(object):
    ...
    def replace(self, **kwds):
        ...
        warn(
            "CryptContext().replace() has been deprecated in Passlib 1.6, "
            "and will be removed in Passlib 1.8, "
    ...
    def __init__(
        ...
        **kwds
        ...
        if policy is not _UNSET:
            warn(
                "The CryptContext ``policy`` keyword has been deprecated as of Passlib 1.6, "
    ...
    def _set_policy(self, policy):
        warn(
            "The CryptPolicy class and the ``context.policy`` attribute have "
    ...
    policy = property(
        _get_policy,
        _set_policy,
        doc="[deprecated] returns CryptPolicy instance " "tied to this CryptContext",
    )
    ...
    def load(self, source, update=False, section="passlib", encoding="utf-8"):
        ...
        if isinstance(source, unicode_or_bytes_types):
            if PY3:
                ...
                source = to_bytes(
                    source, "utf-8", source_encoding=encoding, param="source"
                )
...
class LazyCryptContext(CryptContext):
    ...
    def _lazy_init(self):
        ...
        if "create_policy" in kwds:
            warn(
                "The CryptPolicy class, and LazyCryptContext's "
