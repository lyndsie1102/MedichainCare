...
class MiscTest(TestCase):
    ...
    def test_consteq(self):
        ...
        for l, r in [
            ...
            (u("abcabc"), u("abzabc")),
            (u("abcabc"), u("abcabz")),
            ((u("\xff\xa2\x12\x00") * 10)[:-1] + u("\x01"), u("\xff\xa2\x12\x00") * 10),
...
class CodecTest(TestCase):
    ...
    def test_to_native_str(self):
        ...
        # test utf-8
        self.assertEqual(
            to_native_str(u("\xe0"), "utf-8"), "\xe0" if PY3 else "\xc3\xa0"
        )
        self.assertEqual(
            to_native_str(b"\xc3\xa0", "utf-8"), "\xe0" if PY3 else "\xc3\xa0"
        )
...
class Base64EngineTest(TestCase):
    ...
    def test_ab64_encode(self):
        ...
        # reject unicode
        self.assertRaises(
            TypeError if PY3 else UnicodeEncodeError,
            ab64_encode,
            hb("69b7").decode("latin-1"),
        )
