...
module_info[builtins] = dict(
    ...
    __import__=[
        (0, lambda name, globals=None, locals=None, fromlist=None, level=None: None)
    ],
)
...
module_info[builtins].update(
    ...
    compile=[
        (
            0,
            lambda source, filename, mode, flags=0, dont_inherit=False, optimize=-1: None,
        )
    ],
    max=[
        (
    ...
    open=[
        (
            0,
            lambda file, mode="r", buffering=-1, encoding=None, errors=None, newline=None, closefd=True, opener=None: None,
        )
    ],
...
module_info["toolz.functoolz"] = dict(
    ...
    InstanceProperty=[
        (0, lambda fget=None, fset=None, fdel=None, doc=None, classval=None: None)
    ],
)
